...
// provider failure.
var ErrFileEmbeddingUnsupported = errors.New("the configured embedding model does not take file input (name gemini-embedding-2 in OCHAKAI_EMBEDDINGS, design doc 0146 §5)")
