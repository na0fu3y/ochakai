...
-- lexical half of search works without them (design doc 0147 §5). Say so
...
\echo '(OCHAKAI_EMBEDDINGS; design doc 0147 §1). Nothing to measure.'
\quit
\endif
...
-- spaces (design doc 0147 §3) — so the busiest one wins and the count
