...
| サーフェスの配分 | [0015](0015-surface-consistency.md)、[0004](0004-cli.md)(CLI)、[0007](0007-api-only-cli.md)、[0033](0033-context-hits-are-a-ranking.md)(context)、[0039](0039-mcp-stdio-bridge.md)(MCP stdio)、[0049](0049-listings-page-rankings-do-not.md)(一覧と順位の分け方) |
| Web UI | [0006](0006-web-ui-serving.md)(配信)、[0044](0044-web-ui-edits-documents.md)(編集)、[0032](0032-webui-iap-identity.md)(identity) |
| 検証ループと利用測定 | [0025](0025-closing-the-loop.md)、[0029](0029-usage-recording-off-the-read-path.md)、[0037](0037-stale-and-source-lookup.md)、[0049](0049-listings-page-rankings-do-not.md)(一覧のページング) |
...
- [0049 一覧はカーソルでページングし、順位はしない](0049-listings-page-rankings-do-not.md)
...
- [0025 書き戻しループを締める](0025-closing-the-loop.md) —
  **Accepted**(§6 は 0015 §4 の verify 糖衣の判断を覆した。フィードは
  ...
  追記に改め、再検証が履歴として残る。フィードのページングは 0049)。
