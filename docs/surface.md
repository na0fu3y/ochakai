...
[#369](https://github.com/na0fu3y/ochakai/issues/369) は両方を同時に
やった — REST を自分のサービスに埋め込む開発者のための
docs/guides/rest-integration.md を一枚足し、deploy/cloudrun/README.md
の §5c(委譲された provenance の全文)をそこへの一段落に畳んだ。ページ
が増えたぶんは畳み込みで相殺されず、5,762 から 5,896 まで上げている —
