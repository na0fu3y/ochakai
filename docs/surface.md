...
**足すと決めたら、どちらの住所に置くかは
[0046 §3.5](design/0046-bundle-address-space.md) が決めている** —
バンドルの住所はオブジェクトと OKF が定めたその表現を、id 面はこの
インスタンスが concept について観測した台帳を運ぶ。この文書が数えるのは
大きさで、あの一文が決めるのは置き場所である。
