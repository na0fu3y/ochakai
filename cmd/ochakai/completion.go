...
complete -c ochakai -n '__fish_seen_subcommand_from search list' -l type -x -a '@TYPES@' -d 'filter by type'
complete -c ochakai -n '__fish_seen_subcommand_from search list' -l status -x -a '@STATUSES@' -d 'filter by status'
