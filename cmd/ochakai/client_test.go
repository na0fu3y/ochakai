...
func TestClientCommandsCoverDesignDoc(t *testing.T) {
	for _, name := range []string{"search", "browse", "context", "get", "create", "update", "verify", "delete", "purge", "reembed", "move", "attach", "detach", "usage", "report", "revisions", "backlinks", "compile", "export", "import", "use", "whoami", "ui", "completion"} {
