...
振っているだけなので、衣料品の実際の返品率として読んではいけない。効いて
くるのは閾値を置くときで、実務の感覚で 5% と置くと候補が何百行も出る。
[返品率の高い商品の見直し](/actions/review-high-return-products.md)が
`threshold` に 0.45 以上を要求するのは、そのためである。

この指標が閾値を超えた商品を洗い出して取り扱いの見直しにかけるのが、
その[返品率の高い商品の見直し](/actions/review-high-return-products.md)
である。眺めるための指標ではなく、行動の入力として使う。
