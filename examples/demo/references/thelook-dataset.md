...
このバンドルは、Google が公開している合成 EC データセット
`bigquery-public-data.thelook_ecommerce` を扱う。架空の衣料品店
...
テーブルは 7 つあり、そのうち判断の載っている 4 つをカタログ化してある。
...
いけない理由は二つあり、この未来日付の行と、生成器が直近数日に作る山で
ある。どちらも[売上の読み方](/insights/reading-revenue.md)にある。
